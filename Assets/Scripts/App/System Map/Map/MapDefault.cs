...
namespace App.Map
{
    ...
    public class MapDefault : MapModel
    {
        ...
        private MeshFilter MapMeshFilter => m_MapMeshFilter != null ? m_MapMeshFilter : GetComponent<MeshFilter>();
        ...
        private MeshRenderer MapMeshRenderer => m_MapMeshRenderer != null ? m_MapMeshRenderer : GetComponent<MeshRenderer>();
        ...
        private void GenerateNoiseMap()
        {
            ...
            transform.localScale = new Vector3(transform.localScale.x, m_HeightMultiplier / 2, transform.localScale.z);
            MapMeshRenderer.enabled = true;
        }
